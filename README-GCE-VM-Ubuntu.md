### ULAPPH Installation in Google Compute Engine (CGE) VM with Ubuntu Linux
...
drwxr-xr-x  3 edwin_d_vinas edwin_d_vinas 4096 Mar 25 18:57 ULAPPH-Cloud-Desktop-CTL
```
